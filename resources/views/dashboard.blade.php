...
<section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
      ...
      <p style="font-size: 15px; color : white ; font-stretch: expanded;">
        SOFTWARE MICROFINANCE & BISNIS TERBAIK
      </p>
      <p style="font-size: 45px; font-weight: bold; color : white ; ">
      Kelola Pinjaman dan Laporan Keuangan dengan Lebih Mudah!</p>
      <p style="font-family: Verdana, Geneva, Tahoma, sans-serif;color : white ; font-size: 20px;">Terintegrasi dengan Inventori,
        Proyek, dan
        Penggajian.</p>
      <p style="color: white;">#FeelTheProsperity.</p>
      <div class="d-flex">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              <div class="icon">
                <img src="time-management.png" alt="manage" width="50" height="50">">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              <div class="icon">
                <img src="global-network.png" alt="network" width="45" height="45">">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              <div class="icon">
                <img src="transaction.png" alt="transaction" width="45" height="45">">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              <div class="icon">
                ...
                <img src="responsive-design.png" alt="device" width="45" height="45">">
              </div>
        ...
        <ul class="nav nav-tabs row gy-4 d-flex justify-content-center">
          ...
          <li class="nav-item col-6 col-md-4 col-lg-2">
            <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#tab-1">
              ...
              <img src="integration.png" alt="integration" width="50" height="50">
              <h4>Integrated</h4>
            </a>
          </li><!-- End Tab 1 Nav -->
          ...
          <li class="nav-item col-6 col-md-4 col-lg-2">
            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-2">
              ...
              <img src="shield.png" alt="monitor" width="50" height="50">
              <h4>Safaty</h4>
            </a>
          </li><!-- End Tab 2 Nav -->
          ...
          <li class="nav-item col-6 col-md-4 col-lg-2">
            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-3">
              ...
              <img src="monitor.png" alt="monitor" width="50" height="50">
              <h4>Monitoring</h4>
            </a>
          </li><!-- End Tab 3 Nav -->
          ...
          <li class="nav-item col-6 col-md-4 col-lg-2">
            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-4">
              ...
              <img src="stopwatch.png" alt="monitor" width="50" height="50">
              <h4>RealTime</h4>
            </a>
          </li><!-- End Tab 4 Nav -->
